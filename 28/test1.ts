/*
    * class: [access modifiers] and [type annotations]:
...
class User1 {
    private u: string;                                  // [access modifiers]
    protected s: number;                                // [access modifiers]
    msg: () => string;                                      // the only way
    constructor(userName: string, salary: number) {     // [type annotations] with class
        this.u = userName;
