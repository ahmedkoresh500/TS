...
function returnAll(value: string | number | boolean): string | number | boolean {
    return value;
};
...
console.log( returnType <string> (false) );             // syntax error =>> [false] not string
console.log( returnType <number> ([1, 2, 3]) );         // syntax error =>> [1, 2, 3] not number
